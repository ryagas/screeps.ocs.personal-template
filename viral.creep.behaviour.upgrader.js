...
mod.run = function(creep) {
    ...
    else if(creep.data.homeRoom=='W54S82' && 
        Creep.action.boosting.assign(creep) || creep.data.homeRoom=='W45S87' &&
        Creep.action.boosting.assign(creep)){
        // console.log(JSON.stringify(creep.action));
        return creep.action.step(creep);
    } else {
